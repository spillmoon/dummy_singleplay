...
function listBoards(callback) {
    ...
    board.push({
        boardNo: 1,
        image: "http://ec2-52-78-118-8.ap-northeast-2.compute.amazonaws.com:8080/boardimg/board1.jpg"
    });
    callback(null, board);
}
...
function findBoard(boardNo, callback) {
    var board = "http://ec2-52-78-118-8.ap-northeast-2.compute.amazonaws.com:8080/boardimg/board1.jpg"; // 하나의 결과 담긴 result 배열 객체의 index 0
